...
], RunsController.prototype, "getSystemStatus", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RunsController.prototype, "findAllByProject", null);
__decorate([
    (0, common_1.Post)('projects/:projectId/runs'),
    __param(0, (0, common_1.Param)('projectId')),
    __param(1, (0, common_1.Body)('userSteps')),
    __param(2, (0, common_1.Body)('browser')),
    __metadata("design:type", Function),
