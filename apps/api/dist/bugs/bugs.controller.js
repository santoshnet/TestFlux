...
__decorate([
    (0, common_1.Get)('runs/:runId/bugs'),
    __param(0, (0, common_1.Param)('runId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BugsController.prototype, "findAllByRun", null);
__decorate([
    (0, common_1.Get)('bugs/:bugId'),
    __param(0, (0, common_1.Param)('bugId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BugsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)('bugs/:bugId'),
    __param(0, (0, common_1.Param)('bugId')),
